import { IReviewListItem, IStoreReview } from "@/types/api";
...
interface IStoreReviewSpecific extends IStoreReview {
  reviewList: IReviewListItemSpecific[];
}

export const reviews: IStoreReviewSpecific = {
  overallStats: {
    rating: 70,
    totalReviews: 10,
    stats: [
